  ...
  <html lang="fr">
    ...
    <body> 
      ...
      <!-- SCROLL TOP BUTTON -->
      <a class="scrollToTop" href="#header"><i class="fa fa-angle-up"></i></a>
            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> 
              ...
              <div id="navbar" class="navbar-collapse collapse">
                <ul id="top-menu" class="nav navbar-nav navbar-right main_nav">
                  ...
                  <li id="participants_link"><a href="#participants">Participants</a></li>         
          ...
          <div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
            ...
            <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
              ...
              <div id="cd-login"> <!-- log in form -->
                <form class="cd-form">
                  <p class="fieldset">
                    ...
                    <input class="full-width has-padding has-border" id="signin-email" name="email" placeholder="E-mail">
              ...
              <div id="cd-signup"> <!-- sign up form -->
                <form class="cd-form">
                  <p class="fieldset">
                    ...
                    <input class=" has-padding has-border" id="signup-username" name="nom" type="text" placeholder="Nom">
                    <label class="image-replace cd-username" for="signup-username">Nom d'utilisateur</label>
                    <input class=" has-padding has-border" id="signup-userprenom" name="prenom" type="text" placeholder="Prenom">
                    <span class="cd-error-message">Message d'erreur ici!</span>
                  </p>
                  ...
                  <p class="fieldset">
                    ...
                    <input class="full-width has-padding has-border" id="signup-password" name="password" type="text"  placeholder="Mot de passe">
                    <a href="#0" class="hide-password">Cacher</a>
                    <span class="cd-error-message">Message d'erreur ici!</span>
                  </p>
                  ...
                  <p class="fieldset">
                    ...
                    <label for="accept-terms">J'accepte les <a href="#0">termes.</a></label>
                  </p>

                  <p class="fieldset">
                    <input class="full-width has-padding" type="submit" value="Creer un compte">
                  </p>
                </form>
              ...
              <div id="cd-reset-password"> <!-- reset password form -->
                <p class="cd-form-message">Mot de passe perdu ou oublié? Nous vous envoyons par mail un lien pour créer un nouveau mot de passe.</p>
                ...
                <ul class="slides-container">
                  ...
                  <li>
                    ...
                    <div class="slider_caption">
                      ...
                      <p>Expo-Forum pour l'entrepreuneuriat en Afrique</p>      
                    </div>
                  </li>
        ...
        <div class="container">
          <div class="row col-lg-12 col-md-12">
            ...
            <div class="heading">
              ...
              Ainsi, il est important pour nous de mieux faire connaître le continent, de parler des opportunités qui s’y trouvent et de partager notre passion.</br>
              ...
              <ul>
                ...
                <li>
                  <a href="http://http://www.cdpa-int.com/agrisatch/" target="_blank"> AGRISATCH </a> au Bénin qui produit localement des œufs de qualité en grande quantité.
                </li>
                <li>
                  <a href="http://www.ietp.com/fr/iot" target="_blank"> IOT </a> à Madagascar qui réalise de l’aquaculture industrielle de concombres de mer. 
                </li>
                <li>
             ...
             N'hésitez plus et rejoignez nous. </br>
                     ...
                     echo  '
                            <div class="col-lg-3 col-md-3 col-sm-4">
                              <div class="single_participants wow fadeInUp">
                                ...
                                <h5 class="" >'.$membre[$i]['prenom'].' '.$membre[$i]['nom'].'.</h5>
                                <span>'.jesuisstring($membre[$i]['jesuis']).'</span>
                                <p>'.$membre[$i]['description'].'</p>
                              </div>
                            </div>
                            ';
                    }
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="form-group">
                      ...
                      <div class="form-group">
                        <button type="submit" class=" cd-signup btn-main pull-right"><span class="fui-mail ">Envoyer</span></button>
                    </div>
           ...
           <div class="row">
             <div class="col-lg-6 col-md-6 col-sm-6">
               <div class="footer_left">
                 ...
                 <p>Copyright &copy; 2015 Groupe X-Afrique. All Rights Reserved</p>
               </div>
             </div>
             <div class="col-lg-6 col-md-6 col-sm-6">
               <div class="footer_right">
                 <ul class="social_nav">
                   <li><a href="https://www.facebook.com/MamaAfricaX?fref=photo"><i class="fa fa-facebook"></i></a></li>
                   <li><a href="https://twitter.com/XAfrique"><i class="fa fa-twitter"></i></a></li>
                 </ul>
               </div>
             </div>
           </div>
