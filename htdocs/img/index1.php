              ...
              <div id="navbar" class="navbar-collapse collapse">
                <ul id="top-menu" class="nav navbar-nav navbar-right main_nav">
                  ...
                  <nav class="main-nav" style="text-align : right;">      
                    <li><a class="cd-signup" href="profil.php">Profil</a></li>
                ...
                <ul class="slides-container">
                  ...
                  <li>
                    ...
                    <div class="slider_caption">
                      ...
                      <a href="profil.php" class="slider_btn">N'oubliez pas de mettre à jour votre profil</a>  
                    </div>
                  </li>
        ...
        <div class="container">
          <div class="row col-lg-12 col-md-12">
            ...
            <div class="heading">
             ...
             N'hésitez plus et rejoignez nous. In Africa we trust.
              </div>
            </div>
          </div>
        </div>
